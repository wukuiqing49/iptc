...
class GenerateWebsiteTests(unittest.TestCase):
    ...
    def test_bing_verification_index_now_and_llms_assets_are_generated(self) -> None:
        ...
        self.assertIn("https://pixel-notes.example/about", sitemap)
        ...
        self.assertNotIn('href="about.html"', index)
        self.assertIn('<link rel="canonical" href="https://pixel-notes.example/about">', about)
        self.assertNotIn("https://pixel-notes.example/about.html", about)
        manifest = json.loads((self.output / "static-site-manifest.json").read_text(encoding="utf-8"))
